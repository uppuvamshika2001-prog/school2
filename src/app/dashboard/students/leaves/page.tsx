...
export default function StudentLeaveAdminPage() {
        ...
        <div className="space-y-6">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Manage leave applications from students</CardDescription>
                </CardHeader>
                <CardContent>
                    <LeaveTable leaves={studentLeaves} />
                </CardContent>
            </Card>
                    ...
                    <div className="grid gap-4 py-4">
                        <div className="grid gap-2">
                            ...
                            <Input
                                ...
                                placeholder="E.g., Incomplete assignment..."
                            />
                        </div>
                    </div>
                    <DialogFooter>
