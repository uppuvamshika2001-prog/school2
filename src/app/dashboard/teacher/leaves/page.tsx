    ...
    return (
        <div className="space-y-6">
            <div className="flex flex-col gap-2">
                <h1 className="text-3xl font-bold tracking-tight">Staff Leave Portal</h1>
                <p className="text-muted-foreground">Manage your leave applications and view approval history.</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <Card className="md:col-span-2">
                    <CardHeader>
                        ...
                        <CardDescription>Your past leave requests status</CardDescription>
                    </CardHeader>
                    <CardContent>
                            ...
                            <table className="w-full caption-bottom text-sm text-left">
                                <thead className="[&_tr]:border-b bg-muted/50">
                                    <tr className="border-b transition-colors">
                                        ...
                                        <th className="h-12 px-4 align-middle font-medium text-muted-foreground text-right w-[150px]">Admin Remarks</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {isLoading ? (
